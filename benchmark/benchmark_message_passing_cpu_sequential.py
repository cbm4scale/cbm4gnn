...
from torch import (arange, bool, cuda, device, ones, testing, no_grad, tensor, zeros_like, float32, rand, set_num_threads)
set_num_threads(1)
...
if __name__ == "__main__":
    ...
    message_passing_classes_names = {NativePytorchScatterAddMessagePassing: "Native Pytorch Scatter Add",
                                     ...
                                     MKLSequentialCSRSparseMatrixMessagePassing: "MKL CSR Sparse Matrix",
                                     CBMSequentialMKLCSRSparseMatrixMessagePassing: "CBM MKL CSR Sparse Matrix",
                                     CBMSequentialTorchCSRSparseMatrixMessagePassing: "CBM Native Torch CSR Sparse Matrix",
                                     }
