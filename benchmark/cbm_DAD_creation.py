...
from benchmark.utility import download_and_return_datasets_as_dict, calculate_compression_ratio_dad
...
def benchmark_datasets(name_edge_index_dict):
    ...
    for name, data in name_edge_index_dict.items():
        ...
        for alpha_i in alphas:
            ...
            compression_ratio = calculate_compression_ratio_dad(edge_index, c)
